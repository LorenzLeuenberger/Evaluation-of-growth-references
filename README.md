...
Scripts from another repository []() were used to clean the data. Prior to this, RDF graph data was received from the SwissPedHealth National Data Stream ([www.swisspedhealth.com](https://www.swisspedhealth.com/)) and was flattened into tabular .csv format using SPARQL queries.
